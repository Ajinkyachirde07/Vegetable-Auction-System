...
// 		$ccn = mysqli_connect("localhost", "root", "", "nilamee");
// if (!$ccn) {
//     die("Connection failed: " . mysqli_connect_error());
// }

// // Select database
// $db_selected = mysqli_select_db($ccn, "nilamee");
// if (!$db_selected) {
//     die("Database selection failed: " . mysqli_error($ccn));
// }
		...
		// if (!$rs) {
		// 	die("Query error: " . mysqli_error($ccn));
		// }
