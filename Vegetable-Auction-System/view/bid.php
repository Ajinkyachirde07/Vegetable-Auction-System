			...
			<div class="row">
				...
				<div class="col-md-5">
					...
					<dl class="dl-horizontal">
						...
						$con = mysqli_connect("localhost", "root", "", "nilamee");
						...
						// Select database (optional if already specified in connection)
						// mysqli_select_db($con, "nilamee");
						
						// Fetch data from database using prepared statement
						$stmt = mysqli_prepare($con, "SELECT * FROM addproducts WHERE pid = ?");
